...
workspacesRouter.get('/workspaces', async (_req, res) => {
  try {
    ...
    nativeLog.error('GET /workspaces failed', error)
...
workspacesRouter.post('/workspaces', async (req, res) => {
  try {
    ...
    nativeLog.error('POST /workspaces failed', error)
...
workspacesRouter.put('/workspaces/reorder', async (req, res) => {
  try {
    ...
    nativeLog.error('PUT /workspaces/reorder failed', error)
...
workspacesRouter.patch('/workspaces/:id', async (req, res) => {
  try {
    ...
    nativeLog.error('PATCH /workspaces/:id failed', error)
...
workspacesRouter.delete('/workspaces/:id', async (req, res) => {
  try {
    ...
    nativeLog.error('DELETE /workspaces/:id failed', error)
...
workspacesRouter.get('/workspaces/:workspaceId/sessions', async (req, res) => {
  try {
    ...
    nativeLog.error('GET /workspaces/:workspaceId/sessions failed', error)
...
workspacesRouter.post('/workspaces/:workspaceId/sessions', async (req, res) => {
  try {
    ...
    nativeLog.error('POST /workspaces/:workspaceId/sessions failed', error)
...
workspacesRouter.put('/workspaces/:workspaceId/files', async (req, res) => {
  try {
    ...
    nativeLog.error('PUT /workspaces/:workspaceId/files failed', error)
